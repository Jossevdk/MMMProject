...
class coupled:
    ...
    ### Update ###
    def update(self, E,PsiRe, PsiIm, dy, dt, hbar, m, q, r, potential, n,order,N, Efield):
        ...
        #E = copy.deepcopy(Efield[2*Nx//4,1:] + Efield[2*Nx//4,:-1])/2
        PsiImo = PsiIm
    ...
    def calc_wave(self, dy, dt, Ny, Nt,  hbar, m ,q ,potential,alpha,order,N):
        ...
        for n in range(0, Nt):
            if n % 100 ==0 :
                ...
                E = Efield[2*Nx//4,:]
                #print(Efield)
            PsiRe, PsiIm, J, prob = self.update( E,PsiRe, PsiIm, dy, dt, hbar, m, q, r, potential, n,order,N, Efield)
